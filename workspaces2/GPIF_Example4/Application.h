...
#define NULL ((void *)0)
// I2C by Tony #define UART_CTS			(54)	// Also LED
...
#define CPLD_RESET			(29)	// Hold CPLD in RESET until I've set up and am ready to run
#define CPLD_PUSH_BUTTON	(28)	// Debounced PushButton // Jan 22 BZ
